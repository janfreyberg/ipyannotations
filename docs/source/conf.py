...
# -*- coding: utf-8 -*-
#
# ipyannotations documentation build configuration file
#
...
_version_py = os.path.join(repo, "ipyannotations", "_version.py")
version_ns = {}
...
htmlhelp_basename = "ipyannotationsdoc"
...
man_pages = [
    (master_doc, "ipyannotations", "ipyannotations Documentation", [author], 1)
]
